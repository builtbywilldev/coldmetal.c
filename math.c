...
// File: math.c
// Coldmetal Phase: 4
// Purpose: Vector operations for attention and similarity in memory systems
// Linked to: attention.h, memory.h
// Notes: Provides normalized dot products, projections, distances, and angles
// ===============================================================
